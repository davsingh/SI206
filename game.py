...
from pygame.locals import Rect, DOUBLEBUF, QUIT, K_ESCAPE, KEYDOWN, K_DOWN, \
    K_LEFT, K_UP, K_RIGHT, KEYUP, K_LCTRL, K_RETURN, FULLSCREEN, RESIZABLE
...
class Explosion(pygame.sprite.Sprite):
    def __init__(self, x, y):
        ...
        sheet = pygame.image.load("Mike.bmp")
        self.images = []
...
class BulletSprite(pygame.sprite.Sprite):
    def __init__(self, x, y):
        ...
        self.image = pygame.image.load("basketball.bmp")
        self.rect = self.image.get_rect()
...
class EnemySprite(pygame.sprite.Sprite):
    def __init__(self, x_pos, groups):
        ...
        self.image = pygame.image.load("steph.bmp").convert_alpha()
        self.rect = self.image.get_rect()
...
class ShipSprite(pygame.sprite.Sprite):
    def __init__(self, groups, weapon_groups):
        ...
        self.image = pygame.image.load("lbj.bmp").convert_alpha()
        self.rect = self.image.get_rect()
...
def main():
    background = BackGround('bballCourt.bmp', [0,0])
    game_over = False
